...
sgx_status_t SHA512_ecall(sgx_enclave_id_t eid, sgx_status_t* retval, unsigned char fault_hash[66])
{
	sgx_status_t status;
	ms_SHA512_ecall_t ms;
	ms.ms_fault_hash = (unsigned char*)fault_hash;
